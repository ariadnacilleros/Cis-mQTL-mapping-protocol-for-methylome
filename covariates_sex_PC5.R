...
PC <- read.table("covariates/whole_genome_maf05_filt_samples_prunned.PCs.eigenvec", sep=" ")
...
write.table(x = t(cov), file = "covariates/covariates_sex_PC5.txt", quote = F, row.names = T, col.names = F, sep = "\t") 
