...
PC <- read.table("Git_workflow/whole_genome_maf05_filt_samples_prunned.PCs.eigenvec", sep=" ")
...
#Step 5: Write the final text file
write.table(x = t(cov), file = "Git_workflow/covariates_sex_PC5.txt", quote = F, row.names = T, col.names = F, sep = "\t") 
